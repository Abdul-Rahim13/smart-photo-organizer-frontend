        ...
        <div className="w-full max-w-sm">
          ...
          {step === 1 && (
            <div>
              <a
                href="/login"
                className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-violet-600 transition mb-6"
              >
          ...
          {step === 2 && (
            <div>
              ...
              <p className="text-sm font-semibold text-violet-600 mb-8">
                {email}
              </p>
              ...
              >
                {code.map((digit, idx) => (
                  <input
                    ...
                    onKeyDown={(e) =>
                      handleCodeKeyDown(e, idx)
                    }
                    className={`w-12 h-12 text-center text-lg font-bold text-gray-900 bg-gray-50 border rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-violet-500 transition ${
                      digit
              ...
              <button
                ...
                className={`w-full py-3 text-white text-sm font-bold rounded-xl transition mb-4 ${
                  loading
                    ? "bg-violet-400 cursor-not-allowed"
                    : "bg-violet-600 hover:bg-violet-700 cursor-pointer"
                }`}
              ...
              <p className="text-xs text-gray-400 text-center">
                ...
                <button
                  type="button"
                  className="cursor-pointer text-violet-600 font-semibold hover:underline"
                >
                  Resend
                </button>
              </p>
          ...
          {step === 4 && (
            <div className="flex flex-col items-center text-center">
              ...
              <a
                href="/login"
                className="w-full block py-3 bg-violet-600 hover:bg-violet-700 text-white text-sm font-bold rounded-xl text-center transition"
              >
                Back to login
              </a>
            </div>
...
export default function ForgetPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-150 h-75 bg-violet-200/30 blur-3xl rounded-full pointer-events-none" />
